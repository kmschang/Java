 ...
 * Suduko Project
 *
 * Do loop to find the all zero board. While scanning them in, I check for zero
 * and report where they are. I then later check for what type of problem it is.
 * Then I solve it and print the answers to the console.
 *
 */
...
public class Suduko {
  ...
  public static void main(String[] args) {
    ...
    // num_zero for the number of zeros found in the board, used to determine
    // which way to solve num_board for the number of boards that have been
    // scanned in, used for formatting at the end
    int num_zero;
    int num_board = 0;
    ...
    do {
      ...
      // initializing the answer, one array for the x values and one for the y
      // values, the indexes should match up
      ...
      for (int row = 0; row < 9; ++row) {
        for (int col = 0; col < 9; ++col) {
          // num is a placeholder, the number that was just scanned, that way I
          // can use if more than once in the block of code
  ...
  public static int vertical(int col, int[][] board) {
    ...
    // statement, by default its 9 to eliminate and else statement
    int missing_int = 9;
