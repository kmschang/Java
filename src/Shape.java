public class Shape {
  ...
  public static double getPerimeter() { return perimeter; }
...
class Circle extends Shape {
  ...
  public static double getArea() { return Math.PI * radius * radius; }

  public static double getPerimeter() { return 2 * Math.PI * radius; }
}
...
class Rectangle extends Shape {
  ...
  public static double getArea() { return width * height; }

  public static double getPerimeter() { return 2 * (width + height); }
}
