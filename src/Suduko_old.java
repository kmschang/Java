 ...
 *
 * This is my program used to solve an unknown number of Suduko boards. It takes
 * in all the numbers with one big scanner and put it into one big
 * multidimensional array. Then it takes them out one board at a time and solves
 * them. After solving, it puts the answers into an array and at the end, it
 * prints all the solutions. I tried to use as many functions as I could, but it
 * got a lot because I had to input functions into functions. The hardest part
 * was trying to figure out how to take everything in with one scanner with an
 * unknown amount of boards and then still solve them. The second-hardest part
 * was wrapping my head around arrays and making them all fit and work together.
 *
 */
...
public class Suduko_old {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      // three missing in a board
        ...
        // need to solve first one horizontally and then the other two
        // vertically once we put the other back into the board
        else if (three_missing(check_for_zero(board)) == 3) {

          int a = horizontal(check_for_zero(board)[0][0], board);
          int x = check_for_zero(board)[0][0];
          int y = check_for_zero(board)[0][1];
          board[check_for_zero(board)[0][0]][check_for_zero(board)[0][1]] =
        ...
        // need to solve the last one horizontally and then the other two
        // vertically once we put the other back into the board
          ...
          board[check_for_zero(board)[2][0]][check_for_zero(board)[2][1]] =
  ...
  public static int[][] check_for_zero(int[][] board) {
    ...
    // x coordinate of array where the x values are stored. increased each loop
    // so a number is placed in its respective spot
    int x = 0;
  ...
  public static int vertical(int col, int[][] board) {
    ...
    // finds the missing one and returns the value to be put in a print
    // statement
    int missing_int = 9;
